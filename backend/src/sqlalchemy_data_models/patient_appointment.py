...
class PatientAppointment(ModelBase):
    ...
    ehr_id = mapped_column(String(85), nullable=False)
    scheduled_time = mapped_column(DateTime(timezone=True), nullable=False)
    deleted_flag = mapped_column(Boolean, nullable=False, default=False)
    appt_is_break = mapped_column(Boolean, nullable=False, default=False)
    status = mapped_column(String(85), nullable=False, default="No Status")
    ...
    hour = mapped_column(Integer, nullable=True, default=None)
    minute = mapped_column(Integer, nullable=True, default=None)
    ...
    def to_dict(self):
        ...
        # Filter out appointments that are breaks
        if self.appt_is_break:
            return None
    ...
    create_required_fields = ["practice_id", "practice_patient_id"]
