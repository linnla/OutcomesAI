...
SELECT setval('appointment_procedure_codes_id_seq', (SELECT MAX(id) FROM appointment_procedure_codes));
...
SELECT setval('public.medication_dosages_id_seq', (SELECT MAX(id) FROM public.medication_dosages));
...
SELECT setval('tms_protocols_id_seq', (SELECT MAX(id) FROM tms_procotcols));
